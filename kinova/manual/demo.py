...
def main():
    ...
    with utilities.DeviceConnection.createTcpConnection(args) as router:
        ...
        time.sleep(1.2)
        success &= myCartesianMovement(base,base_cyclic, -1,0.0,0.0)
        time.sleep(1.0)
        success &= myCartesianMovement(base,base_cyclic, 2,0.0,0.0)
        time.sleep(1.0)
        # success &= myCartesianMovement(base,base_cyclic, 0.0,1.0,0.0)
        # time.sleep(1.0)
        # success &= myCartesianMovement(base,base_cyclic, 0.0,1.0,0.0)
        # time.sleep(1.0)
        # success &= myCartesianMovement(base,base_cyclic, 0.0,1.0,0.0)
